            ...
            if(res){
                ...
                for(var i=0;i<this.data.length;i++){
                    ...
                    for(var j=2;j<day.data.length - 2;j++){
                        if(day.data[j] == '2' && day.data[j - 2] == '1' && day.data[j + 2] == '1')day.data = this.setChar(day.data, j);
                    }
                }
                for(var i=0;i<this.data.length;i++){
                    var day=this.data[i];
                    for(var j=1;j<day.data.length - 1;j++){
                        if(day.data[j] == '2' && day.data[j - 1] == '1' && day.data[j + 1] == '1')day.data = this.setChar(day.data, j);
                    }
                }
            }
        }catch(error){
